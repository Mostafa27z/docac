                ...
                <tr class="border-b border-[#E2E8F0] hover:bg-[#F8F9FA] transition-colors">
                    <td class="py-4 px-4 font-semibold text-[#1A202C]">
                        <div class="flex items-center gap-3">
                            @if($course->thumbnail)
                                <img src="https://iframe.mediadelivery.net/play/{{ config('services.bunny.stream_library_id') }}/{{ $course->thumbnail }}" class="w-10 h-10 rounded-xl object-cover border border-[#E2E8F0]" onerror="this.src='/logo.jfif'" />
                            @else
